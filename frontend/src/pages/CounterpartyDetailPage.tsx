    ...
    <div className="bg-[var(--hover-2)] rounded-2xl border border-[var(--border-color)] overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-[var(--border-color)] flex items-center justify-between bg-[var(--hover-1)]">
        <h2 className="text-lg font-bold text-[var(--text-primary)] flex items-center gap-2.5">
          ...
          Продукты
          {totalItems > 0 && (
            <span className="px-2 py-0.5 rounded-full bg-[var(--hover-3)] text-sm text-[var(--text-primary)]/50">{totalItems}</span>
          )}
        </h2>
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => showForm ? closeForm() : setShowForm(true)}
            className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-base font-medium transition-all ${showForm
                ...
                : 'bg-[var(--accent)] hover:bg-[var(--accent)] text-white shadow-md shadow-[var(--shadow-md)]'
              }`}>
            ...
            {selectedProduct ? (
              <div className="flex items-center gap-3 p-4 bg-[var(--hover-2)] border border-[var(--border-color)] rounded-xl">
                {(() => {
                  ...
                  return <div className={`w-11 h-11 rounded-xl ${c?.bg || 'bg-[var(--hover-2)]'} flex items-center justify-center ${c?.color || 'text-[var(--text-primary)]/40'} flex-shrink-0`}><I size={20} /></div>;
                })()}
                ...
                <button onClick={() => { setSelectedProduct(null); setFilterQuery(''); }}
                  className="p-1.5 rounded-lg text-[var(--text-primary)]/30 hover:text-[var(--accent)] transition-colors">
                  <X size={16} />
                </button>
              </div>
            ) : (
            ...
            <>
              ...
              <div className="flex items-center justify-between p-4 bg-[var(--hover-1)] border border-[var(--border-color)] rounded-xl">
                ...
                <button onClick={() => setLinkPrimary(!linkPrimary)}
                  className={`relative w-11 h-6 rounded-full transition-colors ${linkPrimary ? 'bg-[var(--accent)]' : 'bg-[var(--hover-1)]'}`}>
              ...
              <button onClick={handleLink} disabled={linking}
                className="w-full flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[var(--accent)] hover:bg-[var(--accent)] text-white text-base font-medium transition-colors disabled:opacity-40 disabled:cursor-not-allowed shadow-[var(--shadow-md)]">
          ...
          return (
            <div key={product.id} className={isExpanded ? 'bg-[var(--hover-1)]' : ''}>
              <button onClick={() => setExpandedId(isExpanded ? null : product.id)}
                ...
                <div className={`w-11 h-11 rounded-xl ${cat?.bg || 'bg-[var(--hover-2)]'} flex items-center justify-center ${cat?.color || 'text-[var(--text-primary)]/40'} group-hover:scale-105 transition-transform flex-shrink-0`}>
                  <Icon size={20} />
                </div>
                <div className="flex-1 min-w-0">
              ...
              {isExpanded && (
                <div className="px-6 pb-6 pl-20 space-y-5 border-t border-[var(--border-color)]">
                  <div className="flex flex-wrap gap-2.5 pt-4">
                    <span className="flex items-center gap-2 px-3 py-2 rounded-xl bg-[var(--hover-2)] text-base text-[var(--text-primary)]/60 border border-[var(--border-color)]">
  ...
  if (!counterparty) return (
    <div className="bg-[var(--hover-2)] border border-[var(--border-color)] rounded-2xl p-16 text-center">
      ...
      <button onClick={() => navigate('/counterparties')}
        className="px-6 py-2.5 rounded-xl bg-[var(--accent)] hover:bg-[var(--accent)] text-white text-base font-medium transition-colors">
        Вернуться к списку
      </button>
    </div>
  );
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
        ...
        <div className="flex gap-2.5 flex-shrink-0">
          <button className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[var(--hover-2)]
                  ...
                  <div className="mb-6 p-5 space-y-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-lg hover:bg-[var(--hover-2)] text-[var(--text-primary)]/30 hover:text-[var(--text-primary)]/60 transition-colors"
                      >
                        <X size={16} />
                      </button>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div>
                        <label className="block text-sm text-[var(--text-primary)]/50 mb-1.5">
                          Фамилия <span className="text-[var(--accent)]">*</span>
                        </label>
                        <input
                    ...
                    {counterparty.contact_persons.map((person, i) => (
                      <div key={i} className="space-y-4">
                        ...
                        <div className="grid md:grid-cols-2 gap-3">
                          {person.phone && (
                            <div className="bg-[var(--hover-1)] border border-[var(--border-color)] rounded-xl p-4">
                              <p className="text-xs text-[var(--text-primary)]/30 mb-1 flex items-center gap-1.5">
                                <Phone size={12} /> Телефон
                              </p>
                              <a href={`tel:${person.phone}`}
                                className="text-[var(--text-primary)] text-base hover:text-[var(--accent)] transition-colors">
                                {person.phone}
                              </a>
                            </div>
                          )}
                          {person.email && (
                            <div className="bg-[var(--hover-1)] border border-[var(--border-color)] rounded-xl p-4">
                              ...
                              <a href={`mailto:${person.email}`}
                                className="text-[var(--text-primary)] text-base hover:text-[var(--accent)] transition-colors break-all">
                                  {person.email}
                              </a>
                            </div>
                          )}
                        ...
                        {person.messengers?.telegram && (
                          <div className="bg-[var(--hover-1)] border border-[var(--border-color)] rounded-xl p-4">
                            ...
                            <a href={`https://t.me/${person.messengers.telegram.replace('@', '')}`}
                              ...
                              className="text-[var(--text-primary)] text-base hover:text-[var(--accent)] transition-colors flex items-center gap-2">
          ...
          {activeTab === 'customers' && (
            <div className="bg-[var(--hover-2)] rounded-2xl border border-[var(--border-color)] overflow-hidden">
              <div className="px-6 py-5 border-b border-[var(--border-color)] bg-[var(--hover-1)] flex items-center justify-between">
                ...
                <button className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[var(--accent)] hover:bg-[var(--accent)] text-white text-base font-medium transition-colors shadow-md shadow-[var(--shadow-md)]">
            ...
            <div className="bg-[var(--hover-2)] rounded-2xl border border-[var(--border-color)] overflow-hidden">
              <div className="px-6 py-5 border-b border-[var(--border-color)] bg-[var(--hover-1)] flex items-center justify-between">
                ...
                <Link
                  ...
                  className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[var(--accent)] hover:bg-[var(--accent)] text-white text-base font-medium transition-colors shadow-md shadow-[var(--shadow-md)]"
                >
                  ...
                  <div className="divide-y divide-white/[0.05]">
                    {tickets.map(ticket => (
                      <Link key={ticket.id} to={`/tickets/${ticket.number}`}
                        ...
                        <ChevronRight className="w-4 h-4 text-[var(--text-primary)]/20 group-hover:text-[var(--accent)] transition-all flex-shrink-0 mt-1" />
                      </Link>
                    ))}
                  </div>
                )}
